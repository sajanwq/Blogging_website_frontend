...
class DisplaFullBlog extends Component {
                        ...
                        <div class="row  d-flex justify-content-center">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                                ...
                                <div class="tm-blog-post">
                                    ...
                                    <img src={"http://localhost:90/" + localStorage.getItem("BlogImages")}alt="Image" class="img-fluid tm-img-post" />
